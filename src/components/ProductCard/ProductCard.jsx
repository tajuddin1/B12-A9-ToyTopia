...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="card hover:-translate-y-3 transition-all duration-200 ease-in p-5 border bg-base-100 border-base-300">
      <div>
      ...
      <div>
        <h3 className='text-2xl font-BG font-bold mb-3 hover:text-accent line-clamp-1'><Link to={`/shop/${toyId}`}>{toyName}</Link></h3>
